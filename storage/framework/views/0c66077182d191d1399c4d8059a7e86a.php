<?php $__env->startSection('title', $bank->nome . ' - Detalhes da Conta - Giro'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 space-y-4 sm:space-y-0">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($bank->nome); ?></h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($bank->tipo_conta); ?> - Detalhes da conta</p>
        </div>
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('financial.banks.edit', $bank)); ?>" class="flex items-center justify-center w-10 h-10 text-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg" title="Editar">
            ...
            <a href="<?php echo e(route('financial.banks.index')); ?>" class="flex items-center justify-center w-10 h-10 text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 transition-colors hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg" title="Voltar">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($bank->ativo ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'); ?>">
                        <?php echo e($bank->ativo ? 'Ativa' : 'Inativa'); ?>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-sm text-white">
            <div class="p-6">
                ...
                <div class="mb-4">
                    <p class="text-3xl font-bold" id="current-balance">R$ <?php echo e(number_format($bank->saldo_atual, 2, ',', '.')); ?></p>
                    <p class="text-green-100 text-sm mt-1">Atualizado em <?php echo e($bank->updated_at->format('d/m/Y H:i')); ?></p>
                </div>
                <div class="flex items-center text-sm text-green-100">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    ID: #<?php echo e($bank->id); ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('financial.transactions.index', ['bank_id' => $bank->id])); ?>" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium">
                    Ver todas →
                </a>
            </div>
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="<?php echo e(route('financial.transactions.create', ['bank_id' => $bank->id, 'type' => 'receita'])); ?>" class="flex items-center justify-center p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
        ...
        <a href="<?php echo e(route('financial.transactions.create', ['bank_id' => $bank->id, 'type' => 'despesa'])); ?>" class="flex items-center justify-center p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors">
        ...
        <a href="<?php echo e(route('financial.banks.extrato', $bank)); ?>" class="flex items-center justify-center p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
...
function loadRecentTransactions() {
    fetch(`/api/financial/banks/<?php echo e($bank->id); ?>/transactions?limit=5`)
...
function updateBalance() {
    ...
    fetch(`/api/financial/banks/<?php echo e($bank->id); ?>/balance`, {
        method: 'GET',
        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/banks/show.blade.php ENDPATH**/ ?>