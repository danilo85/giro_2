<?php $__env->startSection('title', 'Detalhes do Cartão - Giro'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($creditCard->nome); ?></h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($creditCard->bandeira); ?> • •••• <?php echo e(substr($creditCard->numero, -4)); ?></p>
        </div>
        <div class="flex space-x-2">
            <a href="<?php echo e(route('financial.credit-cards.edit', $creditCard)); ?>" 
            ...
            <a href="<?php echo e(route('financial.transactions.create', ['credit_card_id' => $creditCard->id])); ?>" 
            ...
            <a href="<?php echo e(route('financial.credit-cards.statement', $creditCard)); ?>" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <!-- Card Preview -->
                <div class="bg-gradient-to-br <?php echo e($creditCard->ativo ? 'from-blue-500 to-purple-600' : 'from-gray-400 to-gray-500'); ?> rounded-xl p-6 text-white mb-4">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-xl font-bold"><?php echo e($creditCard->nome); ?></h3>
                            <p class="text-sm opacity-80"><?php echo e($creditCard->bandeira); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-xs opacity-80">Limite Total</p>
                            <p class="text-lg font-bold">R$ <?php echo e(number_format($creditCard->limite_total, 2, ',', '.')); ?></p>
                        </div>
                    </div>
                    <div class="mb-6">
                        <p class="text-2xl font-mono tracking-wider">•••• •••• •••• <?php echo e(substr($creditCard->numero, -4)); ?></p>
                    </div>
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="text-xs opacity-80">Vencimento</p>
                            <p class="text-sm font-medium"><?php echo e($creditCard->data_vencimento ?: '--'); ?></p>
                        </div>
                        <div>
                            <p class="text-xs opacity-80">Fechamento</p>
                            <p class="text-sm font-medium"><?php echo e($creditCard->data_fechamento ?: '--'); ?></p>
                        </div>
                        <div class="text-right">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($creditCard->ativo ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                <?php echo e($creditCard->ativo ? 'Ativo' : 'Inativo'); ?>
                ...
                <div class="space-y-3">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium text-gray-900 dark:text-white"><?php echo e(number_format($percentageUsed, 1)); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                        <div class="h-3 rounded-full transition-all duration-300 <?php echo e($percentageUsed > 80 ? 'bg-red-500' : ($percentageUsed > 60 ? 'bg-yellow-500' : 'bg-green-500')); ?>" 
                             style="width: <?php echo e(min($percentageUsed, 100)); ?>%"></div>
                    </div>
                    <div class="flex justify-between text-sm">
                        <div>
                            <span class="text-gray-600 dark:text-gray-400">Utilizado:</span>
                            <span class="font-medium text-red-600 dark:text-red-400">R$ <?php echo e(number_format($creditCard->limite_utilizado, 2, ',', '.')); ?></span>
                        </div>
                        <div>
                            <span class="text-gray-600 dark:text-gray-400">Disponível:</span>
                            <span class="font-medium text-green-600 dark:text-green-400">R$ <?php echo e(number_format($availableLimit, 2, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($creditCard->nome); ?></p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Bandeira</label>
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($creditCard->bandeira); ?></p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Número do Cartão</label>
                            <p class="text-gray-900 dark:text-white font-mono"><?php echo e($creditCard->numero); ?></p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Status</label>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($creditCard->ativo ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300'); ?>">
                                <?php echo e($creditCard->ativo ? 'Ativo' : 'Inativo'); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white font-medium">R$ <?php echo e(number_format($creditCard->limite_total, 2, ',', '.')); ?></p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Limite Utilizado</label>
                            <p class="text-red-600 dark:text-red-400 font-medium">R$ <?php echo e(number_format($creditCard->limite_utilizado, 2, ',', '.')); ?></p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Dia do Vencimento</label>
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($creditCard->data_vencimento ?: 'Não definido'); ?></p>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Dia do Fechamento</label>
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($creditCard->data_fechamento ?: 'Não definido'); ?></p>
                        </div>
                    </div>
                </div>
                
                <?php if($creditCard->observacoes): ?>
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Observações</label>
                    <p class="text-gray-900 dark:text-white"><?php echo e($creditCard->observacoes); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="text-gray-900 dark:text-white ml-2"><?php echo e($creditCard->created_at?->format('d/m/Y H:i') ?? 'N/A'); ?></span>
                        </div>
                        <div>
                            <span class="text-gray-500 dark:text-gray-400">Última atualização:</span>
                            <span class="text-gray-900 dark:text-white ml-2"><?php echo e($creditCard->updated_at?->format('d/m/Y H:i') ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('financial.credit-cards.statement', $creditCard)); ?>" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
        ...
        <div class="space-y-6">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-red-600 dark:text-red-300 mt-1">
                            Você está usando <?php echo e(number_format($percentageUsed, 1)); ?>% do seu limite. Considere fazer um pagamento.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Next Due Date -->
            <?php if($creditCard->data_vencimento): ?>
            <?php
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="text-center">
                    <div class="text-3xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($daysUntilDue); ?></div>
                    <div class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($daysUntilDue == 1 ? 'dia' : 'dias'); ?></div>
                    <div class="text-sm text-gray-900 dark:text-white mt-2"><?php echo e($nextDueDate?->format('d/m/Y') ?? 'N/A'); ?></div>
                    
                    <?php if($daysUntilDue <= 5): ?>
...
function loadRecentTransactions() {
    fetch(`/financial/api/credit-cards/<?php echo e($creditCard->id); ?>/transactions?limit=5`, {
        headers: {
...
function loadMonthlySummary() {
    ...
    fetch(`/financial/api/credit-cards/<?php echo e($creditCard->id); ?>/monthly-summary?month=${currentMonth}`, {
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
            'Accept': 'application/json'
        }
...
function updateUsedLimit() {
    ...
    fetch(`/financial/api/credit-cards/<?php echo e($creditCard->id); ?>/update-used-limit`, {
        method: 'POST',
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
            'Accept': 'application/json',
...
function payFullInvoice() {
    if (confirm('Deseja pagar a fatura integral deste cartão? Todas as transações pendentes serão marcadas como pagas.')) {
        ...
        fetch(`/financial/api/credit-cards/<?php echo e($creditCard->id); ?>/pay-full-invoice`, {
            method: 'POST',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/credit-cards/show.blade.php ENDPATH**/ ?>