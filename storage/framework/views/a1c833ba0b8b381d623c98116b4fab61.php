            ...
            <li>
                <div class="flex items-center">
                    ...
                    <?php if($orcamento && $orcamento->id): ?>
                         <a href="<?php echo e(route('orcamentos.show', $orcamento->id)); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Orçamento #<?php echo e($orcamento->id); ?></a>
                     <?php endif; ?>
                </div>
            </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro\resources\views/pagamentos/create.blade.php ENDPATH**/ ?>