<?php $__env->startSection('title', 'Nova Transação'); ?>
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0">
                <a href="<?php echo e(route('financial.transactions.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-md transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <form id="transaction-form" action="<?php echo e(route('financial.transactions.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="relative">
                            <input type="radio" id="income-radio" name="type" value="income" class="sr-only" <?php echo e(request('type') === 'income' ? 'checked' : ''); ?>>
                        ...
                        <label class="relative">
                            <input type="radio" id="expense-radio" name="type" value="expense" class="sr-only" <?php echo e(request('type') === 'expense' ? 'checked' : ''); ?>>
            ...
            <div class="flex justify-end space-x-3 mt-6">
                <button type="button" onclick="window.location.href='<?php echo e(route('financial.transactions.index')); ?>'" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-md transition-colors">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/transactions/create.blade.php ENDPATH**/ ?>