        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('pagamentos.update', $pagamento)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $orcamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orcamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($orcamento->id); ?>" 
                                <?php echo e(old('orcamento_id', $pagamento->orcamento_id) == $orcamento->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $bancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($banco->id); ?>" 
                                <?php echo e(old('bank_id', $pagamento->bank_id) == $banco->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" 
                               ...
                               step="0.01" 
                               min="0.01"
                               value="<?php echo e(old('valor', $pagamento->valor)); ?>"
                               required
                               placeholder="0,00"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" 
                           id="data_pagamento" 
                           name="data_pagamento" 
                           value="<?php echo e(old('data_pagamento', $pagamento->data_pagamento->format('Y-m-d'))); ?>"
                           required
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="dinheiro" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'dinheiro' ? 'selected' : ''); ?>>Dinheiro</option>
                        <option value="pix" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'pix' ? 'selected' : ''); ?>>PIX</option>
                        <option value="cartao_credito" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'cartao_credito' ? 'selected' : ''); ?>>Cartão de Crédito</option>
                        <option value="cartao_debito" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'cartao_debito' ? 'selected' : ''); ?>>Cartão de Débito</option>
                        <option value="transferencia" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'transferencia' ? 'selected' : ''); ?>>Transferência Bancária</option>
                        <option value="boleto" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'boleto' ? 'selected' : ''); ?>>Boleto Bancário</option>
                        <option value="cheque" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'cheque' ? 'selected' : ''); ?>>Cheque</option>
                        <option value="outros" <?php echo e(old('forma_pagamento', $pagamento->forma_pagamento) == 'outros' ? 'selected' : ''); ?>>Outros</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="pendente" <?php echo e(old('status', $pagamento->status) == 'pendente' ? 'selected' : ''); ?>>Pendente</option>
                        <option value="processando" <?php echo e(old('status', $pagamento->status) == 'processando' ? 'selected' : ''); ?>>Processando</option>
                        <option value="confirmado" <?php echo e(old('status', $pagamento->status) == 'confirmado' ? 'selected' : ''); ?>>Confirmado</option>
                        <option value="cancelado" <?php echo e(old('status', $pagamento->status) == 'cancelado' ? 'selected' : ''); ?>>Cancelado</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('observacoes', $pagamento->observacoes)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/pagamentos/edit.blade.php ENDPATH**/ ?>