<?php $__env->startSection('title', 'Editar Conta Bancária - Giro'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Atualize as informações da conta <?php echo e($bank->nome); ?></p>
        </div>
        <div class="flex space-x-3">
            <a href="<?php echo e(route('financial.banks.show', $bank)); ?>" class="inline-flex items-center p-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors group" title="Visualizar">
            ...
            <a href="<?php echo e(route('financial.banks.index')); ?>" class="inline-flex items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900/20 transition-colors group" title="Voltar">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <form id="bank-form" action="<?php echo e(route('financial.banks.update', $bank)); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="nome" 
                           name="nome" 
                           value="<?php echo e(old('nome', $bank->nome)); ?>"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['nome'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="tipo_conta" 
                            name="tipo_conta" 
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['tipo_conta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <option value="Conta Corrente" <?php echo e(old('tipo_conta', $bank->tipo_conta) == 'Conta Corrente' ? 'selected' : ''); ?>>Conta Corrente</option>
                        <option value="Conta Poupança" <?php echo e(old('tipo_conta', $bank->tipo_conta) == 'Conta Poupança' ? 'selected' : ''); ?>>Conta Poupança</option>
                        <option value="Conta Salário" <?php echo e(old('tipo_conta', $bank->tipo_conta) == 'Conta Salário' ? 'selected' : ''); ?>>Conta Salário</option>
                        <option value="Conta Investimento" <?php echo e(old('tipo_conta', $bank->tipo_conta) == 'Conta Investimento' ? 'selected' : ''); ?>>Conta Investimento</option>
                        <option value="Conta Digital" <?php echo e(old('tipo_conta', $bank->tipo_conta) == 'Conta Digital' ? 'selected' : ''); ?>>Conta Digital</option>
                    </select>
                    <?php $__errorArgs = ['tipo_conta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="agencia" 
                           name="agencia" 
                           value="<?php echo e(old('agencia', $bank->agencia)); ?>"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['agencia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           id="conta" 
                           name="conta" 
                           value="<?php echo e(old('conta', $bank->conta)); ?>"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['conta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               id="saldo" 
                               name="saldo" 
                               value="<?php echo e(old('saldo', number_format($bank->saldo_atual, 2, ',', '.'))); ?>"
                               class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['saldo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea id="observacoes" 
                          name="observacoes" 
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['observacoes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Informações adicionais sobre esta conta..."><?php echo e(old('observacoes', $bank->observacoes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" id="logo_url" name="logo_url" 
                       value="<?php echo e(old('logo_url', $bank->logo_url)); ?>"
            ...
            <div class="flex items-center">
                ...
                <input type="checkbox" 
                       ...
                       name="ativo" 
                       value="1"
                       <?php echo e(old('ativo', $bank->ativo) ? 'checked' : ''); ?>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                        ...
                        <span class="text-gray-900 dark:text-white ml-1"><?php echo e($bank->created_at->format('d/m/Y H:i')); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-500 dark:text-gray-400">Última atualização:</span>
                        <span class="text-gray-900 dark:text-white ml-1"><?php echo e($bank->updated_at->format('d/m/Y H:i')); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-500 dark:text-gray-400">ID:</span>
                        <span class="text-gray-900 dark:text-white ml-1">#<?php echo e($bank->id); ?></span>
                    </div>
                </div>
            </div>
                        ...
                        <div id="preview-card">
                            <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-4 text-white mb-4">
                                <div class="flex items-center justify-between mb-2">
                                    <span id="preview-bank-name" class="font-semibold"><?php echo e($bank->nome); ?></span>
                                    <span id="preview-account-type" class="text-sm bg-white/20 px-2 py-1 rounded"><?php echo e(ucfirst($bank->tipo_conta)); ?></span>
                                </div>
                                <div class="text-sm opacity-90">
                                    <div>Agência: <span id="preview-agency"><?php echo e($bank->agencia ?: '-'); ?></span></div>
                                    <div>Conta: <span id="preview-account-number"><?php echo e($bank->conta ?: '-'); ?></span></div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span id="preview-balance" class="font-semibold text-green-600"><?php echo e('R$ ' . number_format($bank->saldo_atual, 2, ',', '.')); ?></span>
                                </div>
                                
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600 dark:text-gray-400">Status:</span>
                                    <span id="preview-status" class="px-2 py-1 rounded-full text-xs font-medium <?php echo e($bank->ativo ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>"><?php echo e($bank->ativo ? 'Ativo' : 'Inativo'); ?></span>
                                </div>
                                
                                <div id="preview-observations-section" class="<?php echo e($bank->observacoes ? '' : 'hidden'); ?>">
                                    <span class="text-gray-600 dark:text-gray-400 text-sm">Observações:</span>
                                    <p id="preview-observations" class="text-sm text-gray-700 dark:text-gray-300 mt-1"><?php echo e($bank->observacoes); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/banks/edit.blade.php ENDPATH**/ ?>