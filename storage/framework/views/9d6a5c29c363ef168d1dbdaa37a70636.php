        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('autores.update', $autor)); ?>" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="shrink-0">
                                <img id="avatar-preview" 
                                     ...
                                     src="<?php echo e($autor->avatar ? asset('storage/' . $autor->avatar) : 'data:image/svg+xml,%3csvg width=\'100\' height=\'100\' xmlns=\'http://www.w3.org/2000/svg\'%3e%3crect width=\'100\' height=\'100\' fill=\'%23f3f4f6\'/%3e%3ctext x=\'50%25\' y=\'50%25\' font-size=\'18\' text-anchor=\'middle\' alignment-baseline=\'middle\' font-family=\'monospace, sans-serif\' fill=\'%236b7280\'%3e' . strtoupper(substr($autor->nome, 0, 2)) . '%3c/text%3e%3c/svg%3e'); ?>" 
                                     alt="Avatar preview">
                            </div>
                            <div class="flex-1">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nome" 
                                   name="nome" 
                                   value="<?php echo e(old('nome', $autor->nome)); ?>"
                                   required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   id="email" 
                                   name="email" 
                                   value="<?php echo e(old('email', $autor->email)); ?>"
                                   required
                                   onkeyup="updatePreview()"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="tel" 
                                       id="telefone" 
                                       name="telefone" 
                                       value="<?php echo e(old('telefone', $autor->telefone)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="tel" 
                                       id="whatsapp" 
                                       name="whatsapp" 
                                       value="<?php echo e(old('whatsapp', $autor->whatsapp)); ?>"
                                       placeholder="(11) 99999-9999"
                                       onkeyup="updatePreview()"
                                       oninput="applyPhoneMask(this)"
                                       maxlength="15"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="biografia" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['biografia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('biografia', $autor->biografia)); ?></textarea>
            ...
            <div class="space-y-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center mb-6">
                            <div class="mx-auto h-20 w-20 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center mb-4">
                                <?php if($autor->avatar): ?>
                                    <img src="<?php echo e(asset('storage/' . $autor->avatar)); ?>" class="h-20 w-20 rounded-full object-cover">
                                <?php else: ?>
                        ...
                        <div class="space-y-3">
                            <div>
                                <h4 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo e($autor->nome); ?></h4>
                            </div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <span><?php echo e($autor->email); ?></span>
                                </div>
                                ...
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <span><?php echo e($autor->telefone); ?></span>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <span><?php echo e($autor->whatsapp); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($autor->biografia); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            <div>
                                <h4 class="text-base font-semibold text-gray-900 dark:text-white" id="preview-nome"><?php echo e($autor->nome); ?></h4>
                            </div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    <span id="preview-email"><?php echo e($autor->email); ?></span>
                                </div>
                                
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400" id="preview-telefone-container" style="<?php echo e($autor->telefone ? 'display: flex;' : 'display: none;'); ?>">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                    </svg>
                                    <span id="preview-telefone"><?php echo e($autor->telefone); ?></span>
                                </div>
                                
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400" id="preview-whatsapp-container" style="<?php echo e($autor->whatsapp ? 'display: flex;' : 'display: none;'); ?>">
                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.787"/>
                                    </svg>
                                    <span id="preview-whatsapp"><?php echo e($autor->whatsapp); ?></span>
                                </div>
                            </div>
                            
                            <div id="preview-biografia-container" style="<?php echo e($autor->biografia ? 'display: block;' : 'display: none;'); ?>">
                                <h5 class="text-sm font-medium text-gray-900 dark:text-white mb-2">Biografia</h5>
                                <p class="text-sm text-gray-600 dark:text-gray-400" id="preview-biografia"><?php echo e($autor->biografia); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/autores/edit.blade.php ENDPATH**/ ?>