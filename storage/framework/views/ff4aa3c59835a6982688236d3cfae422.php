<?php $__env->startSection('title', 'Login - Giro'); ?>
...
<div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow-sm border border-gray-200 dark:border-gray-700 sm:rounded-lg sm:px-10">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required 
                           ...
                           placeholder="Endereço de email" value="<?php echo e(old('email')); ?>">
                </div>
                <div>
                ...
                <button type="submit" 
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-6">
                        <a href="<?php echo e(route('social.redirect', 'google')); ?>" 
                           class="relative w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            <?php if(\App\Models\Setting::isPublicRegistrationEnabled()): ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro\resources\views/auth/login.blade.php ENDPATH**/ ?>