...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sistema de Orçamentos'); ?> - <?php echo e(config('app.name', 'Laravel')); ?></title>
                     ...
                     <div class="flex flex-col items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700" :class="{ 'justify-center': $store.sidebar.collapsed && !$store.sidebar.isMobile, 'px-4': $store.sidebar.isMobile }">
                         <a href="<?php echo e(route('dashboard')); ?>" class="flex flex-col items-center">
                             ...
                             <?php if(auth()->check() && auth()->user()->avatar_url): ?>
                                 <img src="<?php echo e(auth()->user()->avatar_url); ?>" alt="<?php echo e(auth()->user()->name); ?>" :class="$store.sidebar.collapsed && !$store.sidebar.isMobile ? 'w-12 h-12' : 'w-16 h-16'" class="rounded-full object-cover flex-shrink-0" style="aspect-ratio: 1/1;">
                             <?php else: ?>
                                 <div :class="$store.sidebar.collapsed && !$store.sidebar.isMobile ? 'w-12 h-12' : 'w-16 h-16'" class="bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                                     <span class="text-white font-bold" :class="$store.sidebar.collapsed && !$store.sidebar.isMobile ? 'text-lg' : 'text-xl'"><?php echo e(auth()->check() ? strtoupper(substr(auth()->user()->name, 0, 1)) : 'U'); ?></span>
                                 </div>
                             <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\giro\resources\views/layouts/app.blade.php ENDPATH**/ ?>