<?php $__env->startSection('title', 'Novo Cartão de Crédito - Giro'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <form action="<?php echo e(route('financial.credit-cards.store')); ?>" method="POST" id="credit-card-form">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nome" name="nome_cartao" value="<?php echo e(old('nome_cartao')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="bandeira" name="bandeira" required
                                ...
                                <option value="Visa" <?php echo e(old('bandeira') == 'Visa' ? 'selected' : ''); ?>>Visa</option>
                                <option value="Mastercard" <?php echo e(old('bandeira') == 'Mastercard' ? 'selected' : ''); ?>>Mastercard</option>
                                <option value="American Express" <?php echo e(old('bandeira') == 'American Express' ? 'selected' : ''); ?>>American Express</option>
                                <option value="Elo" <?php echo e(old('bandeira') == 'Elo' ? 'selected' : ''); ?>>Elo</option>
                                <option value="Hipercard" <?php echo e(old('bandeira') == 'Hipercard' ? 'selected' : ''); ?>>Hipercard</option>
                                <option value="Diners" <?php echo e(old('bandeira') == 'Diners' ? 'selected' : ''); ?>>Diners</option>
                                <option value="Discover" <?php echo e(old('bandeira') == 'Discover' ? 'selected' : ''); ?>>Discover</option>
                                <option value="JCB" <?php echo e(old('bandeira') == 'JCB' ? 'selected' : ''); ?>>JCB</option>
                                <option value="Outros" <?php echo e(old('bandeira') == 'Outros' ? 'selected' : ''); ?>>Outros</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="numero" name="numero" value="<?php echo e(old('numero')); ?>"  maxlength="19"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="limite_total" name="limite_total" value="<?php echo e(old('limite_total')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400">R$</span>
                                <input type="text" id="limite_utilizado" name="limite_utilizado" value="<?php echo e(old('limite_utilizado', '0,00')); ?>"
                                    class="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-colors"
                                    placeholder="0,00">
                            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="data_vencimento" name="data_vencimento"
                                ...
                                <?php for($i = 1; $i <= 31; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e(old('data_vencimento') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                <?php endfor; ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="data_fechamento" name="data_fechamento"
                                ...
                                <option value="">Selecione o dia</option>
                                <?php for($i = 1; $i <= 31; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e(old('data_fechamento') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                <?php endfor; ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="observacoes" name="observacoes" rows="4"
                                ...
                                placeholder="Informações adicionais sobre o cartão..."><?php echo e(old('observacoes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <div class="flex items-center">
                                <input type="checkbox" id="ativo" name="ativo" value="1" <?php echo e(old('ativo', true) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/credit-cards/create.blade.php ENDPATH**/ ?>