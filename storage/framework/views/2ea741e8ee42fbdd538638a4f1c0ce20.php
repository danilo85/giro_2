<?php $__env->startSection('title', 'Editar Usuário - Giro'); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atualize as informações de <?php echo e($user->name); ?></p>
            </div>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="text" 
                       ...
                       required
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="email" 
                       ...
                       required
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <input type="password" 
                           id="password" 
                           name="password" 
                           class="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <select id="is_admin" 
                        name="is_admin" 
                        required
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['is_admin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="0" <?php echo e(old('is_admin', $user->is_admin ? '1' : '0') === '0' ? 'selected' : ''); ?>>Usuário Padrão</option>
                    <option value="1" <?php echo e(old('is_admin', $user->is_admin ? '1' : '0') === '1' ? 'selected' : ''); ?>>Administrador</option>
                </select>
            ...
            <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <span class="text-gray-900 dark:text-white ml-1"><?php echo e($user->created_at->format('d/m/Y H:i')); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-500 dark:text-gray-400">Última atualização:</span>
                        <span class="text-gray-900 dark:text-white ml-1"><?php echo e($user->updated_at->format('d/m/Y H:i')); ?></span>
                    </div>
                    <?php if($user->email_verified_at): ?>
                        <div>
                            <span class="text-gray-500 dark:text-gray-400">Email verificado:</span>
                            <span class="text-green-600 dark:text-green-400 ml-1"><?php echo e($user->email_verified_at->format('d/m/Y H:i')); ?></span>
                        </div>
                    <?php else: ?>
                        <div>
                    ...
                    <div>
                        ...
                        <span class="ml-1 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($user->is_online ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200'); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/users/edit.blade.php ENDPATH**/ ?>