<?php $__env->startSection('title', 'Nova Conta Bancária - Giro'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <form id="bank-form" action="<?php echo e(route('financial.banks.store')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['banco'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <option value="Conta Corrente" <?php echo e(old('tipo_conta') == 'Conta Corrente' ? 'selected' : ''); ?>>Conta Corrente</option>
                    <option value="Conta Poupança" <?php echo e(old('tipo_conta') == 'Conta Poupança' ? 'selected' : ''); ?>>Conta Poupança</option>
                    <option value="Conta Salário" <?php echo e(old('tipo_conta') == 'Conta Salário' ? 'selected' : ''); ?>>Conta Salário</option>
                    <option value="Conta Investimento" <?php echo e(old('tipo_conta') == 'Conta Investimento' ? 'selected' : ''); ?>>Conta Investimento</option>
                    <option value="Conta Digital" <?php echo e(old('tipo_conta') == 'Conta Digital' ? 'selected' : ''); ?>>Conta Digital</option>
                </select>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               id="saldo" 
                               name="saldo" 
                               value="<?php echo e(old('saldo', '0,00')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Informações adicionais sobre esta conta..."><?php echo e(old('observacoes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="url" 
                       ...
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['logo_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/banks/create.blade.php ENDPATH**/ ?>