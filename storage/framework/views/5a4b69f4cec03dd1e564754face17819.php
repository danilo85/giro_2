<?php $__env->startSection('title', 'Lançamentos - Giro'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('financial.dashboard')); ?>" class="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors">
            ...
            <a href="<?php echo e(route('financial.banks.index')); ?>" class="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors">
                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                </svg>
                Bancos
            </a>
            <a href="<?php echo e(route('financial.credit-cards.index')); ?>" class="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors">
                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                </svg>
                Cartões
            </a>
            <a href="<?php echo e(route('financial.categories.index')); ?>" class="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors">
                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="empty-state" class="flex flex-col items-center justify-center py-16 px-4 hidden">
        <div class="text-center max-w-md mx-auto">
            ...
            <a href="<?php echo e(route('financial.transactions.create')); ?>" class="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
...
<div class="fixed bottom-6 right-6 z-50">
    <div class="relative">
        ...
        <div id="fab-menu" class="absolute bottom-16 right-0 space-y-2 hidden">
            <a href="<?php echo e(route('financial.transactions.create', ['type' => 'income'])); ?>" class="bg-green-500 hover:bg-green-600 text-white w-12 h-12 rounded-full shadow-lg transition-all duration-300 flex items-center justify-center" title="Nova Receita">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                </svg>
            </a>
            <a href="<?php echo e(route('financial.transactions.create', ['type' => 'expense'])); ?>" class="bg-red-500 hover:bg-red-600 text-white w-12 h-12 rounded-full shadow-lg transition-all duration-300 flex items-center justify-center" title="Nova Despesa">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 13l-5 5m0 0l-5-5m5 5V6"></path>
                </svg>
            </a>
...
function deleteSelectedInstallments() {
    ...
    const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
    const deleteUrl = '<?php echo e(route("api.financial.transactions.delete-selected-installments")); ?>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const summaryData = {
        receitas: <?php echo e($receitas ?? 0); ?>,
        despesas: <?php echo e($despesas ?? 0); ?>,
        saldo: <?php echo e($saldo ?? 0); ?>,
        pendentes: <?php echo e($pendentes ?? 0); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\giro_2\resources\views/financial/transactions/index.blade.php ENDPATH**/ ?>