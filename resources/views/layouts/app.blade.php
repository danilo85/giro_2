...
<body class="h-full bg-gray-50 dark:bg-gray-900" x-data="{ sidebarOpen: false, sidebarCollapsed: localStorage.getItem('sidebarCollapsed') === 'true' }">
                ...
                <!-- Navigation -->
                 <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                     ...
                     <div class="mt-8">
                         ...
                         <div class="mt-2 space-y-1" :class="{ 'mt-0': sidebarCollapsed }">
