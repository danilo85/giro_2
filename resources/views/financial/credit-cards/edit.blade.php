...
<div class="max-w-7xl mx-auto">
    @php
        $breadcrumbs = [
            ...
            ['name' => $creditCard->nome_cartao, 'url' => '#']
        ];
    @endphp

    <x-breadcrumb :items="[['label' => 'Home', 'url' => route('dashboard')], ['label' => 'Financeiro', 'url' => route('financial.dashboard')], ['label' => 'Cartões de Crédito', 'url' => route('financial.credit-cards.index')], ['label' => $creditCard->nome_cartao]]" />
